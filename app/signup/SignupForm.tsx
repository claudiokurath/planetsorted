      ...
      <div className="w-full max-w-md rounded-3xl bg-black border border-white/10 p-8 sm:p-10 text-center shadow-2xl">
        ...
        {inboxUrl && (
          <a
            ...
            className="mt-6 block w-full rounded-2xl bg-gradient-to-r from-[#1FD7CF] via-[#5095FF] to-[#856CFF] py-3.5 text-sm font-bold uppercase tracking-wider text-[#050608] transition-opacity hover:opacity-90 shadow-lg"
          >
            Jump to Your Email →
          </a>
        )}
  ...
  return (
    <div className="w-full max-w-md rounded-3xl bg-black border border-white/10 p-8 sm:p-10 shadow-2xl">
      <div className="mb-8 text-center">
        <div className="mx-auto mb-4 h-1 w-12 rounded-full bg-[#1FD7CF]" />
        <h1
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-2xl border border-neutral-800 bg-black px-4 py-3.5 text-sm text-white placeholder-neutral-500 focus:border-[#1FD7CF] focus:outline-none focus:ring-2 focus:ring-[#1FD7CF]/20 disabled:opacity-50 font-mono"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={state === 'loading'}
          className="w-full rounded-2xl bg-gradient-to-r from-[#1FD7CF] via-[#5095FF] to-[#856CFF] py-3.5 text-sm font-bold uppercase tracking-wider text-[#050608] transition-opacity hover:opacity-90 shadow-lg disabled:opacity-50"
        >
