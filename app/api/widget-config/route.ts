...
const WIDGET_TOOLS = [
  {
    ...
    url: 'https://www.sor7ed.com/adhd-tax-calculator',
    category: 'Wealth',
  },
  {
    ...
    url: 'https://www.sor7ed.com/weekly-wins-generator',
    category: 'Body',
  },
  {
    ...
    url: 'https://www.sor7ed.com/biometric-state-tracker',
    category: 'Body',
  },
  {
    ...
    url: 'https://www.sor7ed.com/decision-paralysis-solver',
    category: 'Mind',
  },
  {
    ...
    url: 'https://www.sor7ed.com/financial-autopilot',
    category: 'Wealth',
  },
  {
    ...
    url: 'https://www.sor7ed.com/brain-dump-sorter',
    category: 'Mind',
  },
]
...
export async function GET() {
  return NextResponse.json(
    {
      tools: WIDGET_TOOLS,
      widget_src: 'https://www.sor7ed.com/widget.js',
      usage: '<script src="https://www.sor7ed.com/widget.js" data-tool="adhd-tax-calculator" data-partner="your-clinic" async></script>',
      lead_capture: {
        endpoint: 'https://www.sor7ed.com/api/leads',
