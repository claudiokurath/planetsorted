        ...
        <div className="mt-8 space-y-6 text-base sm:text-lg leading-relaxed text-neutral-300">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-[#141414] p-6 space-y-3">
            ...
            <p className="text-base text-neutral-300">
              Email: <a href="mailto:hello@planetsorted.com" className="text-[#F5C518] underline font-semibold">hello@planetsorted.com</a>
            </p>
            <p className="text-base text-neutral-300">
              WhatsApp: <a href="https://wa.me/447591922247" target="_blank" rel="noopener noreferrer" className="text-[#F5C518] underline font-semibold">+44 7591 922247</a>
            </p>
          </div>
        </div>
      </div>
