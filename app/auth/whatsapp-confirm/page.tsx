  ...
  return (
    <main className="flex min-h-[calc(100vh-80px)] items-center justify-center bg-black p-6 text-white">
      <div className="w-full max-w-lg rounded-none border border-white/10 bg-black p-8 sm:p-10">
        <p className="text-[10px] font-normal uppercase tracking-[0.22em] text-[#C6A052]">SOR7ED verification</p>
        ...
        <Link href={href} className="mt-8 inline-flex min-h-14 w-full items-center justify-center rounded-full bg-[#C6A052] px-6 text-sm font-normal uppercase tracking-wider text-black">
          {label} →
        </Link>
      </div>
    </main>
