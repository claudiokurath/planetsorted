...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-2xl px-6 py-12 text-neutral-300">
      <h1 className="mb-6 font-bebas text-4xl uppercase leading-[1.15] tracking-normal text-white sm:text-5xl lg:text-6xl">Privacy Policy</h1>
      ...
      <p className="mt-10 text-sm text-neutral-500">
        If you have any questions about this policy, drop us an email at <a href="mailto:hello@planetsorted.com" className="text-[#F5C518] underline">hello@planetsorted.com</a>.
      </p>
    </article>
  )
}
