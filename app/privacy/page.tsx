...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-2xl px-6 py-12 text-neutral-300">
      <h1 className="mb-6 font-bebas text-5xl font-black uppercase tracking-tight text-white sm:text-6xl">Privacy Policy</h1>
      ...
      <h2 className="mt-8 mb-4 text-xl font-semibold text-white">Who we are</h2>
      <p>
      ...
      <h2 className="mt-8 mb-4 text-xl font-semibold text-white">What we collect & why</h2>
      ...
      <h2 className="mt-8 mb-4 text-xl font-semibold text-white">Consent & WhatsApp</h2>
      <p>
      ...
      <h2 className="mt-8 mb-4 text-xl font-semibold text-white">How we store data</h2>
      <p>
        Your personal data and saved library items are stored securely on Supabase servers located within the UK/EU.
      </p>

      <h2 className="mt-8 mb-4 text-xl font-semibold text-white">We never sell or share your data</h2>
      <p>
        We do not sell, rent, or share your data with advertisers or third parties. We keep things clean, simple, and private.
      </p>

      <h2 className="mt-8 mb-4 text-xl font-semibold text-white">Your rights & GDPR Deletion</h2>
      <p>
      ...
      <p className="mt-10 text-sm text-neutral-500">
        If you have any questions about this policy, drop us an email at <a href="mailto:hello@planetsorted.com" className="text-[#1FD7CF] underline">hello@planetsorted.com</a>.
      </p>
    </article>
  )
}
