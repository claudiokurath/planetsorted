...
const LOOP = [
  { n: '1', head: 'Read an article', body: 'Feel briefly understood — then return to square one with no concrete next step and no lasting change.' },
  { n: '2', head: 'Download an app', body: 'Get overwhelmed by onboarding, confused by the interface, and quietly abandon it within a week.' },
  { n: '3', head: 'Try a planner', body: 'Lose the planner. Feel shame. Stop trying. File the whole episode under "things that don’t work for me."' },
]
...
export function AboutIntro() {
  return (
    <>
      {/* Hero */}
      <section className="mx-auto flex max-w-5xl flex-col items-center gap-7 px-5 py-24 text-center sm:py-32">
