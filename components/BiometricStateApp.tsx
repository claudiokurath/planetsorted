...
function StatRing({ score }: { score: number }) {
  ...
  const col = score >= 70 ? '#22e5d0' : score >= 40 ? '#f59e0b' : '#f87171'
    ...
    <>
      <style>{`
        .bst-slider::-webkit-slider-thumb {
          ...
          border-radius: 50%; background: #22e5d0; cursor: pointer;
              ...
              <div className="md:col-span-2 flex flex-col sm:flex-row items-center gap-4">
                ...
                {authChecked && !userId && (
                  <p className="text-xs text-slate-500">
                    ...
                    <a href="/signup" className="text-cyan-400 underline hover:text-cyan-300">Log in</a> to keep a history.
                  </p>
                )}
                    ...
                    return (
                      <div key={row.id} className="glass flex items-center justify-between gap-4 rounded-2xl px-5 py-4">
                        ...
                        <button
                          ...
                          aria-label="Delete"
                          className="shrink-0 rounded-lg px-3 py-1.5 text-xs text-slate-500 transition hover:bg-red-500/10 hover:text-red-400"
                        >
                          Delete
                        </button>
                      </div>
