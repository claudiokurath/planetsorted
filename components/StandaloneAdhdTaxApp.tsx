    ...
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
        <header className="rounded-none border border-white/10 bg-black p-8 shadow-2xl backdrop-blur">
          <p className="text-sm font-medium uppercase tracking-[0.35em] text-cyan-300">Independent app</p>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              {[
                ...
                <label key={field.label} className="block text-sm text-slate-300">
                  ...
                  <input
                    ...
                    className="w-full rounded-none border border-white/10 bg-black px-4 py-3 text-white outline-none ring-0 focus:border-cyan-400"
                  />
                </label>
              ))}
            </div>
          ...
          <section className="rounded-none border border-cyan-400/30 bg-cyan-500/10 p-6 shadow-2xl">
            <p className="text-sm font-medium uppercase tracking-[0.3em] text-cyan-300">Estimated annual leak</p>
            ...
            <div className="mt-6 rounded-none border border-white/10 bg-black p-4">
              <h3 className="text-lg font-medium">Quick reset plan</h3>
